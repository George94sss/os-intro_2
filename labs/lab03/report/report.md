...
- Перешел в настройки GitHub ([https://github.com/settings/keys](https://github.com/settings/keys)), нажал на кнопку *New GPG key* и вставил полученный ключ в поле ввода.
